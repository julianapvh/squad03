        ...
        if opcoes_trocas_devolucoes == '1':
                            ...
                            \nFotos do item recebido:\nErrado: item recebido de cor/tamanho diferentesDanificado: \
                                \nembalagem danificada, itens quebrados ou com danos (amassados, riscos)Com defeito: \
                                    é comum que seja algum eletrônico, por isso, pedimos que você nos forneça alguma captura de tela \
                                        com o dispositivo plugado que mostre qual é o problemaIncompleto: imagem com todos os itens recebidos \
                                            no pedido - \ncaso esteja faltando alguma peça ou componente \
                                                \nHistórico do chat ou qualquer outra evidência que nos mostre alguma negociação prévia \
                                                    com o vendedor (se houver)')

        elif opcoes_trocas_devolucoes == '2':
            print('Política de Trocas e Devoluções \nTroca por defeito de fabricação: Caso o produto apresente defeito de fabricação em até 30 dias \
                corridos a partir dos dados de recebimento do produto, o cliente deverá entrar em contato com nossa central de atendimento e \
                    solicitar a troca do produto. O produto deve estar em perfeitas condições, sem sinais de uso, e com embalagem original. \
                        O valor do frete da devolução do produto e da entrega \nDevolução por produto com defeito após 30 dias: Caso o produto \
                            apresente defeito após 30 dias corridos a partir dos dados do destinatário do produto, o cliente deverá entrar em contato \
            ...
            print('Devolução por arrependimento: Caso o cliente se arrependa da compra e queira devolver o produto, deverá entrar em contato \
                com a nossa central de atendimento em até 7 dias corridos a partir dos dados de recebimento do produto. \
                    O produto deve estar em perfeitas condições, sem sinais de uso, e com embalagem original. O valor do produto será estornado, \
                        mas o valor do frete não será reembolsado. \nTroca por insatisfação: Caso o cliente fique insatisfeito com o produto, mas \
                            ele esteja em perfeitas condições, sem sinais de uso, e com a embalagem original, poderá solicitar a troca do produto \
                                em até 30 dias corridos a partir dos dados de recebimento do produto . O valor do frete da devolução do produto \
                                    e da entrega do novo produto será de responsabilidade do cliente.')
